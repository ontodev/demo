...
# install nanobot
WORKDIR /tools
RUN git clone -b use-valve https://github.com/ontodev/nanobot.git
...
RUN pip install -e .
# install valve
RUN pip install -i https://test.pypi.org/simple/ ontodev-valve

## install sprocket
#WORKDIR /tools
#RUN git clone -b main https://github.com/ontodev/sprocket.git
...
## install gadget
#WORKDIR /tools
#RUN git clone -b main https://github.com/ontodev/gadget.git
