...
def build_form(args):
    output = [
        "form",
        {"action": "upload.py", "method": "POST", "enctype": "multipart/form-data"},
        # ["p", str(args)],
        ["input", {"type": "hidden", "name": "action", "value": "upload"}],
        build_input(args, "Upload demo.xlsx", input_type="file"),
...
def main():
    ...
    if action == "create":
        ...
        # Save XLSX to demo.xlsx
        os.chdir("../..")
        wb = load_workbook(fields["upload_demo.xlsx"].file)
        wb.save("demo.xlsx")
